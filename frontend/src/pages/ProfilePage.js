        ...
        <div style={{ paddingBottom: '80px' }}>
            <div style={s.header}>
                ...
                <div style={{display: 'flex', gap: '15px', alignItems: 'center'}}>
                    <button onClick={toggleTheme} style={s.iconBtn}>{darkMode ? <FaSun size={20} color="orange" /> : <FaMoon size={20} />}</button>
                        ...
                        {post.imageUrl ? (
                            isVideo(post.imageUrl) ? (
                                <div style={{position: 'relative', width: '100%', height: '100%'}}>
                                    <video src={getImgUrl(post.imageUrl)} style={s.gridImage} muted />
                                    <div style={s.videoIcon}><FaVideo color="white" /></div>
                                </div>
                            ) : <img src={getImgUrl(post.imageUrl)} alt="Post" style={s.gridImage} />
